...
locals {
  ...
  ec2_instance_name = var.ec2_instance_name == null ? var.ec2_instance_id : var.ec2_instance_name
  ...
  alarm_name = var.alarm_name == null ? "${local.ec2_instance_name}Ec2${var.statistic}${var.metric_name}${var.comparison}${var.threshold}In${var.evaluation_periods}PeriodsOf${var.period}" : var.alarm_name
}
